...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/img/cut.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCut->setIcon(icon5);
        actionExit = new QAction(MainWindow);
        actionExit->setObjectName("actionExit");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/img/exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/img/bar.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/img/bar2.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionStatus->setIcon(icon14);
        actionRedo = new QAction(MainWindow);
        actionRedo->setObjectName("actionRedo");
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/img/redo.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/img/Hang.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionLine->setIcon(icon16);
        actionPrint = new QAction(MainWindow);
        actionPrint->setObjectName("actionPrint");
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/img/print.jpg"), QSize(), QIcon::Normal, QIcon::Off);
