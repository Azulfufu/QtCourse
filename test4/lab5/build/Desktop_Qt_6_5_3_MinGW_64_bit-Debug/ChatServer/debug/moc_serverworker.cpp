...
Q_CONSTINIT static const qt_meta_stringdata_CLASSServerWorkerENDCLASS_t qt_meta_stringdata_CLASSServerWorkerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(70, 20),  // "disconnectFromClient"
        QT_MOC_LITERAL(91, 11),  // "onReadyRead"
        QT_MOC_LITERAL(103, 11),  // "sendMessage"
        QT_MOC_LITERAL(115, 4),  // "text"
        QT_MOC_LITERAL(120, 4),  // "type"
        QT_MOC_LITERAL(125, 8),  // "sendJson"
        QT_MOC_LITERAL(134, 4)   // "json"
    },
    "ServerWorker",
    "logMessage",
    "",
...
void ServerWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (_t _q_method = &ServerWorker::disconnectFromClient; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
